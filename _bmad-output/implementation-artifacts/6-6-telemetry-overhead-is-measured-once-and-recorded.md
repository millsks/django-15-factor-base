...
- [ ] Task 1 — Name the owner and the milestone before measuring anything (AC: #3)
  ...
  - [ ] Note for the caller: the spine's Open Items entry at `ARCHITECTURE-SPINE.md:502` should be updated once both are decided. Editing a planning artifact is a separate, deliberate act — flag it rather than folding it into an implementation commit.
