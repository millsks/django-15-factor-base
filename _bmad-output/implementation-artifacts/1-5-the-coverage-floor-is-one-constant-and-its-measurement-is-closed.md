...
- [Source: _bmad-output/planning-artifacts/epics.md:225] — three declarations move into `accelerator.toml` in Epic 7 without changing meaning.
- [Source: _bmad-output/planning-artifacts/epics.md:345] — Story 1.5's omit list is one of them.
